...
-- Tell pg_partman to manage standard monthly partitioning for this table
-- SELECT partman.create_parent(
--   p_parent_table := 'public.auth_audit_log',
--   p_control := 'created_at',
--   p_type := 'native',
--   p_interval := 'monthly',
--   p_premake := 3 -- Always keep 3 months ahead created
-- );
